  ...
  _createClass(Task, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement("input", { className: "d-inline-block mt-2", type: "checkbox", onChange: function onChange() {
...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=48").then(checkStatus).then(json).then(function (response) {
